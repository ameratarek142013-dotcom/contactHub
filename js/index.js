      ...
      let contact = {
        ...
        groupStyle:
          groupInput.value == "Family"
            ...
            : groupInput.value == "Friends"
              ? "text-success bg-success-subtle"
              : groupInput.value == "School"
                ? "text-warning bg-warning-subtle"
                : groupInput.value == "work"
                  ? "text-purble bg-lpurble"
...
function displayContact() {
  ...
  for (let i = 0; i < contactList.length; i++) {
    count++;
    if (
      contactList[i].name.toLowerCase().includes(tirm.toLowerCase()) ||
      contactList[i].phone.includes(tirm) ||
      contactList[i].mail.toLowerCase().includes(tirm.toLowerCase())
    ) {
